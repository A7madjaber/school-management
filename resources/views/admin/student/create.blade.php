@extends('admin.layouts.master',['title'=>trans('main_trans.Add_student')])
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('admin.student.store')}}" autocomplete="off">
                        ...
                        <button class="btn btn-success btn-sm nextBtn btn-lg" type="submit">{{trans('Students_trans.submit')}}</button>
                        </div>
                    </form>
