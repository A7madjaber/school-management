@extends('admin.layouts.master',['title'=> trans('My_Classes_trans.title_page')])



@section('content')
    <!-- row --> <h3 class="font-weight-light">{{trans('My_Classes_trans.List_classes')}}</h3>
    <br>
    <div class="row">
        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-success btn-lg fa fa-plus" data-toggle="modal" data-target="#exampleModal"
                            title="{{ trans('My_Classes_trans.add_class') }}">
                    </button>

                    <button title="{{ trans('My_Classes_trans.delete_checkbox') }}" type="button"
                            class=" btn btn-danger fa fa-trash btn-lg" id="btn_delete_all">

                    </button>

                    <br><br>

                    <form action="{{ route('admin.classroom.filter') }}" method="POST">
                      @csrf
                        <select class="custom-select w-25" data-style="btn-info" name="Grade_id" required
                            ...
                            @foreach ($classes as $class)
                                <tr id="{{$class->id}}">
                                    ...
                                    <td>
                                        ...
                                        <button id="delete" data-route="{{route('admin.classroom.delete')}}"
                                                title="{{ trans('My_Classes_trans.Delete') }}"data-id="{{$class->id}}"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class=" row mb-30" action="{{ route('admin.classroom.store') }}" method="POST">
                            @csrf
    ...
    <div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.classroom.delete_all') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal-body">
