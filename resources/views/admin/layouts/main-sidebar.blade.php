                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('admin.classroom.index')}}">{{trans('main_trans.List_classes')}}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('admin.section.index')}}">{{trans('main_trans.List_sections')}}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('admin.student.create')}}">{{trans('main_trans.Add_student')}}</a> </li>
                            <li> <a href="{{route('admin.student.index')}}">{{trans('main_trans.list_Students')}}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('admin.teacher.index')}}">{{trans('main_trans.list_Teachers')}} </a> </li>
                    ...
                    <li>
                        ...
                        <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('admin.parent.list')}}">{{{trans('main_trans.List_Parents')}}} </a> </li>
                        </ul>
                    </li>
